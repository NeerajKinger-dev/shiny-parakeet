...
const legends = {
  ...
  buses: [
    { color: "bg-purple-600", label: "Excellent (9-10)" },
    { color: "bg-purple-500", label: "Good (7-8.9)" },
    { color: "bg-purple-400", label: "Average (5-6.9)" },
    { color: "bg-purple-300", label: "Poor (3-4.9)" },
    { color: "bg-purple-200", label: "Very Poor (0-2.9)" },
  ],
  metros: [
    { color: "bg-purple-600", label: "Excellent (9-10)" },
    { color: "bg-purple-500", label: "Good (7-8.9)" },
  ...
  ev_charging: [
    { color: "bg-green-500", label: "High Density (10+ stations)" },
    { color: "bg-green-400", label: "Good Coverage (6-9 stations)" },
    { color: "bg-green-300", label: "Moderate (3-5 stations)" },
